  ...
  const fetchCurrentWeather = async () => {
    try {
      ...
      setWeather({
        ...
        dtDayTwo: (data.list[1].dt_txt).slice(10, -3),
        ...
        dtDayThree: (data.list[2].dt_txt).slice(10, -3),
        ...
        dtDayFour: (data.list[3].dt_txt).slice(10, -3),
        ...
        dtDayFive: (data.list[4].dt_txt).slice(10, -3),
